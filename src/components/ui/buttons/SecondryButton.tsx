...
export const SecondryButton: Component<{
  ...
  return (
    <button
      class={`bg-white text-qblack dark:text-white text-sm sm:text-base rounded-lg hover:bg-gray-50 duration-300 transition-colors border p-2.5 dark:bg-gray-900 dark:border-gray-700 ${local.class}`}
      {...others}
    >
